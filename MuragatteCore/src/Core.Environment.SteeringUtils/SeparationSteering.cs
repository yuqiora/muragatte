...
{
    public class SeparationSteering : ToNeighboursSteering
    {
        #region Constants

        public const string LABEL = "Separation";

        #endregion

        #region Constructors

        public SeparationSteering(Element element, double weight) : base(element, weight) { }
